...
import vn.edu.tdtu.lab7_5.service.StudentService;
...
public class Lab75Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Student> age18 = this.studentService.studentAgeG_M(18);
        showStudents(age18);

        int ielts8 = this.studentService.countStudentIelts(8);
        System.out.println("\nThe number of students whose ielts score is equal 8: " + ielts8 + " student");

        System.out.println("\nlist of students whose name contains the word 'tuan':");
        List<Student> containTuanInName = this.studentService.keywordInName("tuan");
